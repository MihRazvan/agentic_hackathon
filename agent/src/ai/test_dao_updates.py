...
class DaoUpdatesAgent:
    ...
    def _analyze_proposal_impact(self, proposal_data: Dict) -> ImpactAnalysis:
        ...
        try:
            ...
            messages = [
                HumanMessage(content=f"""Analyze this governance proposal and determine its impact:
...
""")
    ...
    def _analyze_governance_stats(self, stats: Dict) -> str:
        ...
        messages = [
            HumanMessage(content=f"""Analyze these DAO governance statistics and provide a clear, simple explanation:
...
""")
    ...
    def _analyze_treasury_status(self, treasury_data: Dict) -> str:
        ...
        messages = [
            HumanMessage(content=f"""Analyze this DAO's treasury information and explain its significance:
...
""")
    ...
    def _analyze_proposal_outcome(self, proposal: Dict, status: str) -> str:
        ...
        messages = [
            HumanMessage(content=f"""Analyze this proposal's outcome and explain its significance:
...
""")
    ...
    def _generate_delegation_advice(self, user_holdings: str, dao_name: str) -> str:
        ...
        messages = [
            HumanMessage(content=f"""Generate personalized delegation advice for a user:
